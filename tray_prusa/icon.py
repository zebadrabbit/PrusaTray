...
def _draw_status_overlay(painter: QPainter, status: PrinterStatus, size: int, color: QColor) -> None:
    """
...
def test_icon_cache() -> None:
    ...
    icon1 = render_icon(50, PrinterStatus.PRINTING, 32)
    cache_size_1 = len(_icon_cache)
    
    icon2 = render_icon(50, PrinterStatus.PRINTING, 32)
    ...
    icon3 = render_icon(50.5, PrinterStatus.PRINTING, 32)  # Should bucket to 50
    ...
    icon4 = render_icon(51, PrinterStatus.PRINTING, 32)  # Different bucket
