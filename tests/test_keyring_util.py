...
class TestSanitizeKeyForEnv(unittest.TestCase):
    ...
    def test_colon_separator(self):
        ...
        self.assertEqual(
            _sanitize_key_for_env("prusalink:mk4-office"),
            "PRUSALINK_MK4_OFFICE"
        )
    ...
    def test_special_characters(self):
        ...
        self.assertEqual(
            _sanitize_key_for_env("my-key.name@host!"),
            "MY_KEY_NAME_HOST"
        )
...
class TestSetSecret(unittest.TestCase):
    ...
    def test_set_secret_success(self, mock_keyring):
        ...
        mock_keyring.set_password.assert_called_once_with("PrusaTray", "mykey", "mysecret")
...
class TestPromptForCredential(unittest.TestCase):
    ...
    def test_prompt_no_qapplication(self, mock_qapp):
        ...
        with patch.dict('sys.modules', {
            'PySide6.QtWidgets': MagicMock(QApplication=mock_qapp)
        }):
